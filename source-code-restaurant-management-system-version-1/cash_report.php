...
location.replace('cash_report.php?date='+date+'&updated=date&month=')
}
function foo_month(){
var month = document.getElementById("new_month").value;
location.replace('cash_report.php?month='+month+'&updated=month&date=')
}
</script>
